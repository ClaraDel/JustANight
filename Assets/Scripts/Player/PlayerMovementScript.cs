...
public class PlayerMovementScript : MonoBehaviour
{
    ...
    [SerializeField] private GameObject playerCameraOffset;
    ...
    private IEnumerator CrouchStand()
    {
        ...
        Vector3 currentCameraHeight = playerCameraOffset.transform.localPosition;
        ...
        while (timeElapsed < timeToCrouch)
        {
            ...
            playerCameraOffset.transform.localPosition = Vector3.Lerp(currentCameraHeight, targetCameraHeight, timeElapsed / timeToCrouch);
            timeElapsed += Time.deltaTime;
            yield return null;
        }
        characterController.height = targetHeight;
        characterController.center = targetCenter;
        playerCameraOffset.transform.localPosition = targetCameraHeight;
    ...
    private void HandleHeadBob()
    {
        if (characterController.isGrounded)
        {
            if(Mathf.Abs(velocity.x) > 0.1f || Mathf.Abs(velocity.z) > 0.1f)
            {
                ...
                playerCameraOffset.transform.localPosition = new Vector3(
                    playerCameraOffset.transform.localPosition.x,
                    ...
                    playerCameraOffset.transform.localPosition.z);
